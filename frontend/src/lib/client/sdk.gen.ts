...
import type {
  ...
  CreateUserResponses,
  CreateVacationData,
  CreateVacationErrors,
  CreateVacationResponses,
  DeleteGroupData,
  DeleteGroupErrors,
  ...
  DeleteUserResponses,
  DeleteVacationData,
  DeleteVacationErrors,
  DeleteVacationResponses,
  EditGroupData,
  EditGroupErrors,
  EditGroupResponses,
  EditUserData,
  ...
  SetVacationStateData,
  SetVacationStateErrors,
  SetVacationStateResponses,
...
export const deleteVacation = <ThrowOnError extends boolean = false>(
  options: Options<DeleteVacationData, ThrowOnError>
) =>
  (options.client ?? client).delete<
    DeleteVacationResponses,
    DeleteVacationErrors,
...
export const listVacations = <ThrowOnError extends boolean = false>(
  options?: Options<ListVacationsData, ThrowOnError>
) =>
  (options?.client ?? client).get<
    ListVacationsResponses,
    ListVacationsErrors,
    ThrowOnError
  >({ url: '/api/vacation', ...options });

export const createVacation = <ThrowOnError extends boolean = false>(
  options: Options<CreateVacationData, ThrowOnError>
) =>
  (options.client ?? client).post<
    CreateVacationResponses,
    CreateVacationErrors,
...
export const setVacationState = <ThrowOnError extends boolean = false>(
  options: Options<SetVacationStateData, ThrowOnError>
) =>
  (options.client ?? client).put<
    SetVacationStateResponses,
    SetVacationStateErrors,
