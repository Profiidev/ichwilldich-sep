...
export type DeleteVacationRequest = {
  uuid: string;
};
...
export type SetVacationStateRequest = {
  state: ApprovalState;
  uuid: string;
};
...
export type DeleteVacationData = {
  body: DeleteVacationRequest;
  path?: never;
  query?: never;
  url: '/api/vacation';
};

export type DeleteVacationErrors = {
  /**
   * Failed to parse the request body as JSON
   */
  400: string;
...
export type DeleteVacationError =
  DeleteVacationErrors[keyof DeleteVacationErrors];

export type DeleteVacationResponses = {
  /**
   * no content
   */
  200: unknown;
...
export type ListVacationsErrors = {
  /**
   * An error occurred
   */
  '4XX': unknown;
...
export type ListVacationsResponses = {
  200: Array<Vacation>;
};

export type ListVacationsResponse =
  ListVacationsResponses[keyof ListVacationsResponses];
...
export type CreateVacationErrors = {
  /**
   * Failed to parse the request body as JSON
   */
  400: string;
...
export type CreateVacationError =
  CreateVacationErrors[keyof CreateVacationErrors];

export type CreateVacationResponses = {
  200: CreateVacationRes;
};

export type CreateVacationResponse =
  CreateVacationResponses[keyof CreateVacationResponses];

export type SetVacationStateData = {
  body: SetVacationStateRequest;
  path?: never;
  query?: never;
  url: '/api/vacation';
};

export type SetVacationStateErrors = {
  /**
   * Failed to parse the request body as JSON
   */
  400: string;
...
export type SetVacationStateError =
  SetVacationStateErrors[keyof SetVacationStateErrors];

export type SetVacationStateResponses = {
  /**
   * no content
   */
  200: unknown;
